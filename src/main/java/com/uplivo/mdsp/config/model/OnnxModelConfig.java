...
public class OnnxModelConfig {
    ...
    // -------------------------- 1. 模型配置参数 --------------------------
    // ctr_v1 配置
    @Value("${model.deepfm.ctr.v1.model-path}")
    private Resource onnxModelResourceV1;
    @Value("${model.deepfm.ctr.v1.input-node}")
    private String inputNodeNameV1;
    @Value("${model.deepfm.ctr.v1.output-node}")
    private String outputNodeNameV1;

    // ctr_v2 配置
    @Value("${model.deepfm.ctr.v2.model-path}")
    private Resource onnxModelResourceV2;
    @Value("${model.deepfm.ctr.v2.input-node}")
    private String inputNodeNameV2;
    @Value("${model.deepfm.ctr.v2.output-node}")
